...
safe handling guide](../chapters/07/safe_pandas).
...
teaching that subject. See [the dataset page](../chapters/07/safe_pandas) for more on this warning.
...
of Pandas](../chapters/07/safe_pandas).
