...
penalize negative and positive sum of the errors.
...
errors above the line (positive errors) will be roughly equal to the sum of the
...
negative errors and fewer, smaller positive errors, then the sum of error will
...
print('Sum of error for slope of 3.5', np.sum(errors))
```
...
prediction = hgb * 2.5
errors = pcv - prediction
print('Sum of error for slope of 2.5', np.sum(errors))
```
