...
We know the numpy function `random.random_integers` claims to choose randomly
...
for v in np.arange(5):
    tosses[v] = np.random.random_integers(0, 1)
...
v = 0
tosses[0] = np.random.random_integers(0, 1)
v = 1
tosses[1] = np.random.random_integers(0, 1)
v = 2
tosses[2] = np.random.random_integers(0, 1)
v = 3
tosses[3] = np.random.random_integers(0, 1)
v = 4
tosses[4] = np.random.random_integers(0, 1)
...
for i in np.arange(1000):
    tosses[i] = np.random.random_integers(0, 1)
...
`np.random_integers` can take a third argument, corresponding to `size`.  This
call returns an array length 10 of random integers, each of which can be
either 0 or 1.
...
for i in np.arange(N):
    tosses = np.random.random_integers(0, 1, size=100)
