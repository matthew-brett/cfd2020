...
randoms = np.random.random_integers(1, 100, size=12)
# Say values < 27 correspond to black jurors.
# 26 of the numbers 1 through 100 are less than 27 (so 26% or p=0.26).
black_yn = randoms < 27
...
```{python}
randoms = np.random.random_integers(1, 100, size=100)
black_yn = randoms < 27
