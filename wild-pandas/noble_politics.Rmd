...
# Renumber the row labels; not necessary, but to avoid confusion.
...
If you stare at these for a while, you may notice that they go up and down in
exactly the same way.  When the "Yes" / "rescuer" count goes up or down by 1,
so does the "No" / "bystander" count - and the same is true for any change in
the values; 1, 2, 3 ..., -1, -2, -3 ...
