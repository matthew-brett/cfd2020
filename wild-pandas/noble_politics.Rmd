...
We can create the Entry Table in bits, first the "No" / "bystander" rows, then
...
`party_yn` labels in our Entry Table, so the pairing of the `party_yn` and
...
count - and the same is true for any change in the values; 1, 2, 3 ..., -1, -2,
-3 ...
