...
For example, the "Yes" row, "R" column gives the number of rows that have a
"Yes" label for "Party" *and* a "R" label for "Respondent":
...
We can add the row and column totals to this table, with some fancy Pandas code
(unhide the code in this page, or see the notebook version for details):
