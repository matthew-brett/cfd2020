...
import pandas as pd
# Read the file, select the first 6 values.
...
These are the quality ratings corresponding to the `disciplines` we saw
...
Just to confirm that these are the disciplines with "Easiness" ratings greater
than 3, here are the first six rows of the table.  These are the rows
corresponding to numbers in the arrays.

```{python}
# We haven't covered '.head' or data tables yet.  This code shows the first 6
