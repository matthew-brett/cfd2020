...
See the [array indexing page](../arrays-iteration/array_indexing) for more
detail.
...
the [rate_my_course.csv](../data/rate_my_course.csv)
...
Then you can use the usual [array indexing](../arrays-iteration/array_indexing) to get the values you want:
