...
For example, remember the solution to the three girls problem.  Our first
approach to this, in [leaping ahead](../data-types/leaping_ahead) was to use
`np.append` to append values to the end of an array, as we run through the
loop:
