...
These exercises follow on from the three girls solution in [filling arrays](../arrays-iteration/filling_arrays), and the [reply to the Supreme
...
Hint: you may remember from the [Comparison page](../code-basics/Comparison) that `<=`
