...
If you are running on your laptop, first [download the data file](../data/audit_of_political_engagement_14_2017.tab) to the same
...
* [Reply to the Supreme Court](../arrays-iteration/reply_supreme)
* [Final three girls simulation](../arrays-iteration/filling_arrays)
